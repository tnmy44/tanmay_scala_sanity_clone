...
import org.main.scla_dep_mgmt_change.graph.subgraph25Ports.config.{
  Config => subgraph25Ports_Config
}
...
import org.main.scla_dep_mgmt_change.graph.expressions_sg.config.{
  Config => expressions_sg_Config
}
import org.main.scla_dep_mgmt_change.graph.transpiler_gems.config.{
  Config => transpiler_gems_Config
}
...
case class Config(
  ...
  var pm_shared_graph: pm_shared_graph_Config = pm_shared_graph_Config(),
  var all_type_sg_scala_main: all_type_sg_scala_main_Config =
    all_type_sg_scala_main_Config(),
  var RemoveSG:        RemoveSG_Config = RemoveSG_Config(),
  var pipeline_config: String = "pipeline_value",
  var Subgraph_3:      Subgraph_3_Config = Subgraph_3_Config(),
  var Subgraph_4:      Subgraph_4_Config = Subgraph_4_Config(),
  var SNOW_USERNAME:   String = "cicdaccount",
  var SNOW_PASSWORD:   String = "CuIqZ!9I32t@",
  var expressions_sg:  expressions_sg_Config = expressions_sg_Config(),
  var JDBC_PASSWORD:   String = "admin",
  ...
  var transpiler_gems:   transpiler_gems_Config = transpiler_gems_Config(),
  var subgraph25Ports:   subgraph25Ports_Config = subgraph25Ports_Config()
) extends ConfigBase
