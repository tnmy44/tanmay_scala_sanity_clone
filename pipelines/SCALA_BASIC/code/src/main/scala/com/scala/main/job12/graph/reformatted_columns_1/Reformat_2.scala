package com.scala.main.job12.graph.reformatted_columns_1

import io.prophecy.libs._
import com.scala.main.job12.udfs.PipelineInitCode._
import com.scala.main.job12.udfs.UDFs._
import com.scala.main.job12.graph.reformatted_columns_1.config.Context
...
object Reformat_2 {
  ...
  def apply(context: Context, in: DataFrame): DataFrame =
    in.select(
      ...
      col("c_timestamp"),
      concat(col("`c  float`"), col("`c   short  --`"))
